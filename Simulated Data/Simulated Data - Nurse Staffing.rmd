...
A single function to create the simulated data set, `generateDataSet`, is
defined below. This function takes two inputs, a `startDate` and an `endDate`,
and generates survey responses for numerous ficticious employees for each day
between those two dates. Within the function are several sub-functions that
